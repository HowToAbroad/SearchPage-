...
//    semester_array[num]=        columns[14];
        ...
        cource_type_array[num] =  columns[3]; 
        languag_array[num]=columns[7];
        duration1_array[num]=columns[10];
        university_array[num]=columns[2];
        cource_array[num]=columns[5];
        semester_array[num]=columns[9];
        num++;
   ...
   var h2_uni_name = document.createElement('h7')
   var h2_course_type = document.createElement('h9')
   var h2_course_name = document.createElement('h10')
   var h2_language = document.createElement('h20')
   var h2_duration = document.createElement('p')
   var h2_germanranking = document.createElement('h19')
   var h2_world_ranking = document.createElement('h19')
   var h2_begining_semester = document.createElement('p')
   var h2_course_website = document.createElement('h20')
   var h2_submit_application = document.createElement('h12')
   var h2_city = document.createElement('h9')
   var h2_course_ranking = document.createElement('h19')
...
//    Div_right3.className = 'right3_card_part';
   ...
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_university_name).appendChild(h2_uni_name).innerHTML = university_name+":"+city+","+course_type+","+course_name;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_world_ranking).appendChild(h2_world_ranking).innerHTML ="<b>World Ranking:</b>"+world_ranking;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_germanranking).appendChild(h2_germanranking).innerHTML ="<b>Germany Ranking:</b>"+Germany_ranking;
...
//    document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_right).appendChild(div_course_name).appendChild(h2_course_name).innerHTML = course_name;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_course_ranking).appendChild(h2_course_ranking).innerHTML = "<b>Course Ranking:</b>"+course_ranking;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_language).appendChild(h2_language).innerHTML = language;
//    document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_right).appendChild(div_city).appendChild(h2_city).innerHTML = "City:"+city;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_left).appendChild(div_course_website).appendChild(h2_course_website).innerHTML = Course_website;
   document.getElementsByTagName('div')[1].appendChild(Div_block).appendChild(Div_right1).appendChild(div_duration).appendChild(h2_duration).innerHTML = duration_array+","+Beginning_semester;
